import { Controller, Post, UseGuards, Request, HttpCode, HttpStatus, Get, Req, Body, Param, Patch, Delete } from '@nestjs/common';
...
export class UserController {
    ...
    @Roles(ROLES.ADMIN)
    @Patch(':id')
    async update(@Param('id') id: string, @Param('clientId') clientId: string, @Body() updateUserDto: UpdateUserDto) {
