...
import { CategoryGroup, CategoryGroupSchema } from './entities/category-group.entity'
import { AuditLogModule } from '../audit-log/audit-log.module'

@Module({
  imports: [
    MongooseModule.forFeature([{ name: CategoryGroup.name, schema: CategoryGroupSchema }]),
    AuditLogModule,
  ],
